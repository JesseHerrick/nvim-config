...
_G.packer_plugins = {
  gruvbox = {
    ...
    loaded = true,
    path = "/home/jesse/.local/share/nvim/site/pack/packer/start/gruvbox",
    url = "https://github.com/ellisonleao/gruvbox.nvim"
  },
  harpoon = {
    loaded = true,
    path = "/home/jesse/.local/share/nvim/site/pack/packer/start/harpoon",
  ...
  playground = {
    loaded = true,
    path = "/home/jesse/.local/share/nvim/site/pack/packer/start/playground",
  ...
  undotree = {
    loaded = true,
    path = "/home/jesse/.local/share/nvim/site/pack/packer/start/undotree",
